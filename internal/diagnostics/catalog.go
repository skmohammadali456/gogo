...
var Catalog = map[Code]CatalogEntry{
	...
	"G3004": entry("This type alias is invalid or duplicated.", "এই type alias অবৈধ অথবা পুনরাবৃত্ত।", "यह type alias अमान्य या दोहराया गया है।", "Use a unique alias with a resolvable type.", "একটি অনন্য এবং সমাধানযোগ্য alias ব্যবহার করুন।", "एक अद्वितीय और हल होने योग्य alias इस्तेमाल करें।"),
	"G3005": entry("This optional, union, intersection, or result type is malformed.", "এই optional, union, intersection অথবা result type বিকৃত।", "यह optional, union, intersection या result type विकृत है।", "Check the type arguments and composite type members.", "type argument এবং composite type member পরীক্ষা করুন।", "type argument और composite type member जाँचें।"),
	"G3006": entry("This composite type assignment is incompatible.", "এই composite type assignment অসঙ্গত।", "यह composite type assignment असंगत है।", "For unions every possible source member must satisfy the target, and intersections must satisfy every member.", "union-এর প্রতিটি সম্ভাব্য source member target পূরণ করবে এবং intersection প্রতিটি member পূরণ করবে।", "union का हर संभावित source member target को संतुष्ट करे और intersection हर member को संतुष्ट करे।"),
	"G3007": entry("This expression type could not be inferred.", "এই expression-এর type infer করা যায়নি।", "इस expression का type infer नहीं हो सका।", "Add an explicit annotation or use values with known canonical types.", "explicit annotation যোগ করুন অথবা পরিচিত canonical type-এর মান ব্যবহার করুন।", "explicit annotation जोड़ें या ज्ञात canonical type वाले मान इस्तेमाल करें।"),
	"G3008": entry("This condition has no defined GOGO truthiness or narrowing proof.", "এই condition-এর নির্ধারিত GOGO truthiness বা narrowing proof নেই।", "इस condition की परिभाषित GOGO truthiness या narrowing proof नहीं है।", "Use Boolean, Optional, Result, or a proven union/property/discriminant check.", "Boolean, Optional, Result অথবা প্রমাণিত union/property/discriminant check ব্যবহার করুন।", "Boolean, Optional, Result या सिद्ध union/property/discriminant check इस्तेमाल करें।"),
	"G3009": entry("This union handling is not exhaustive.", "এই union handling exhaustive নয়।", "यह union handling exhaustive नहीं है।", "Handle every supported union or discriminated-union member.", "প্রতিটি সমর্থিত union অথবা discriminated-union member handle করুন।", "हर समर्थित union या discriminated-union member संभालें।"),
	"G3001": entry("This type annotation is not a supported canonical GOGO type.", "এই type annotation একটি সমর্থিত canonical GOGO type নয়।", "यह type annotation समर्थित canonical GOGO type नहीं है।", "Use a supported primitive or collection type.", "সমর্থিত primitive অথবা collection type ব্যবহার করুন।", "समर्थित primitive या collection type इस्तेमाल करें।"),
	"G3002": entry("This value is not assignable to the declared type.", "এই মানটি ঘোষিত type-এ assign করা যায় না।", "यह मान घोषित type को assign नहीं किया जा सकता।", "Use a value with the declared canonical type.", "ঘোষিত canonical type-সহ একটি মান ব্যবহার করুন।", "घोषित canonical type वाला मान इस्तेमाल करें।"),
	"G3003": entry("This binding is immutable and cannot be assigned again.", "এই binding অপরিবর্তনীয় এবং আবার assign করা যায় না।", "यह binding अपरिवर्तनीय है और फिर से assign नहीं किया जा सकता।", "Declare a variable when reassignment is required.", "পুনরায় assign করতে variable ঘোষণা করুন।", "पुनः assign करने के लिए variable घोषित करें।"),
	"G3100": entry("This enum declaration or variant is invalid.", "এই enum ঘোষণা অথবা variant অবৈধ।", "यह enum घोषणा या variant अमान्य है।", "Use unique variants and compatible payloads.", "অনন্য variant এবং সামঞ্জস্যপূর্ণ payload ব্যবহার করুন।", "अद्वितीय variant और संगत payload इस्तेमाल करें।"),
	"G3101": entry("This interface is declared more than once.", "এই interface একাধিক বার ঘোষণা করা হয়েছে।", "यह interface एक से अधिक बार घोषित है।", "Use a unique interface name.", "একটি অনন্য interface নাম ব্যবহার করুন।", "एक अद्वितीय interface नाम इस्तेमाल करें।"),
	"G3102": entry("This extended interface cannot be resolved.", "এই প্রসারিত interface সমাধান করা যায়নি।", "इस विस्तारित interface को हल नहीं किया जा सकता।", "Declare the parent interface before extending it.", "প্রসারিত করার আগে parent interface ঘোষণা করুন।", "विस्तार से पहले parent interface घोषित करें।"),
	"G3103": entry("Interface extension is cyclic.", "Interface প্রসারণ চক্রাকার।", "Interface विस्तार चक्रीय है।", "Remove the cyclic extends relationship.", "চক্রাকার extends সম্পর্ক সরান।", "चक्रीय extends संबंध हटाएँ।"),
	"G3104": entry("Interface properties are incompatible.", "Interface property-গুলি অসামঞ্জস্যপূর্ণ।", "Interface properties असंगत हैं।", "Keep inherited properties compatible.", "উত্তরাধিকারসূত্রে পাওয়া property সামঞ্জস্যপূর্ণ রাখুন।", "विरासत properties को संगत रखें।"),
	"G3200": entry("I expected a generic type parameter name.", "আমি generic type parameter নাম প্রত্যাশা করেছি।", "मुझे generic type parameter नाम अपेक्षित था।", "Write a name such as T.", "T-এর মতো নাম লিখুন।", "T जैसा नाम लिखें।"),
	"G3201": entry("This generic type parameter is duplicated.", "এই generic type parameter পুনরাবৃত্ত।", "यह generic type parameter दोहराया गया है।", "Use each type parameter name once.", "প্রতিটি type parameter নাম একবার ব্যবহার করুন।", "हर type parameter नाम एक बार इस्तेमाल करें।"),
	"G3202": entry("This generic parameter list is missing >.", "generic parameter তালিকায় > নেই।", "generic parameter सूची में > नहीं है।", "Close the generic parameter list.", "generic parameter তালিকা বন্ধ করুন।", "generic parameter सूची बंद करें।"),
	"G3203": entry("This type argument list is missing >.", "type argument তালিকায় > নেই।", "type argument सूची में > नहीं है।", "Close the type argument list.", "type argument তালিকা বন্ধ করুন।", "type argument सूची बंद करें।"),
	"G3204": entry("This generic call has invalid type arguments.", "এই generic call-এ invalid type argument আছে।", "इस generic call में invalid type arguments हैं।", "Match the declaration arity.", "declaration arity মিলান।", "declaration arity मिलाएँ।"),
	"G3205": entry("This generic type argument could not be inferred.", "এই generic type argument infer করা যায়নি।", "यह generic type argument infer नहीं हो सका।", "Pass explicit type arguments.", "explicit type argument দিন।", "explicit type arguments दें।"),
	"G3206": entry("This type argument violates its generic constraint.", "এই type argument generic constraint ভঙ্গ করে।", "यह type argument generic constraint तोड़ता है।", "Use a type assignable to the constraint.", "constraint-এ assignable type ব্যবহার করুন।", "constraint को assign होने वाला type इस्तेमाल करें।"),
	"G3207": entry("Generic instantiation did not terminate safely.", "Generic instantiation নিরাপদে শেষ হয়নি।", "Generic instantiation सुरक्षित रूप से समाप्त नहीं हुआ।", "Break recursive generic aliases.", "recursive generic alias ভাঙুন।", "recursive generic aliases तोड़ें।"),
