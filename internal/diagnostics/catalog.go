...
var Catalog = map[Code]CatalogEntry{
	...
	"G2004": entry("I expected a value for this variable.", "এই ভেরিয়েবলের জন্য একটি মান প্রত্যাশিত।", "इस variable के लिए एक मान अपेक्षित है।", "Give the variable an initial value.", "ভেরিয়েবলটির প্রাথমিক মান দিন।", "variable को प्रारंभिक मान दें।"),
